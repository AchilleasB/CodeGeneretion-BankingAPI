    ...
    <div class="account-form">
      ...
      <form @submit.prevent="submitForm">
        <div>
          ...
          <input type="text" id="iban" v-model="account.iban" required />
        </div>
        <div>
        ...
        <div>
          ...
          <input type="date" id="openingDate" v-model="account.openingDate" required />
        </div>
        <div>
        ...
        <div>
          ...
          <input type="number" id="dailyLimit" v-model="account.dailyLimit" required min="0" />
        </div>
        <div>
  ...
  export default {
    ...
    methods: {
      async submitForm() {
        ...
        try {
          await accountStore.createAccount({ ...this.account, userId: this.userId });
